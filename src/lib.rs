...
pub struct MessageReadWriteStream<SendMessageType: Serialize, RecvMessageType: DeserializeOwned, ReadWriter: Read + Write,> {
    send_msg_type: PhantomData<SendMessageType>,
    recv_msg_type: PhantomData<RecvMessageType>,
    readwriter: ReadWriter,
}
impl<SendMessageType: Serialize + TypeHash, RecvMessageType: DeserializeOwned + TypeHash, ReadWriter: Read + Write> MessageReadWriteStream<SendMessageType, RecvMessageType, ReadWriter> {
...
impl<SendMessageType: Serialize, RecvMessageType: DeserializeOwned, ReadWriter: Write + Read> MessageReadWriteStream<SendMessageType, RecvMessageType, ReadWriter> {
